...
public class SQLiteQueryConnector
		implements SQLQueryConnector {
	private final SQLInformation information;
	private Connection connection;
	
	public SQLiteQueryConnector(SQLInformation information) {
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof SQLiteQueryConnector)) {
			return false;
		}
		SQLiteQueryConnector other = (SQLiteQueryConnector) o;
	...
	protected boolean canEqual(Object other) {
		return other instanceof SQLiteQueryConnector;
	}
	
	public String toString() {
		return "SQLiteQueryConnector(information=" + this.getInformation() + ", connection=" + this.getConnection() + ")";
	}
}
